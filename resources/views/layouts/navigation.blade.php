    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('play.index')" :active="request()->routeIs('play.index')">
                        {{ __('MVPs') }}
                    </x-nav-link>
                </div>
                ...
                @if($admin==true)
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('play.create')" :active="request()->routeIs('play.create')">
                            {{ __('Añadir MVP') }}
                        </x-nav-link>
                    </div>
                @endif
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link href="{{url('user/'.$user->id.'/edit')}}">Editar cuenta</x-dropdown-link>
                        <!-- Authentication -->
            ...
            @else
                <a href="{{ route('login') }}" style="margin: 12px;" class="text-gray-700 btn btn-primary">Login</a>

                @if (Route::has('register'))
                    <a href="{{ route('register') }}" style="margin: 12px; margin-left: -400px;" class="text-gray-700 btn btn-success">Regístrate</a>
                @endif
            @endif
